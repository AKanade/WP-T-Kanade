...
function mytheme_add_admin() {
    ...
    if ( $_GET['page'] == basename(__FILE__) ) {
        if ( 'save' == $_REQUEST['action'] ) {
            ...
            header("Location: admin.php?page=Kanade.php&saved=true");
            die;
        }
    }
...
<div class="wrap d_wrap">
    ...
    <h2><?php echo $themename; ?>设置
        <span class="d_themedesc">发布来源：<a href="http://www.kanade.pw/" target="_blank">Kanade</a> &nbsp;&nbsp; <a href="http://www.kanade.pw" target="_blank">访问<?php echo $themename; ?>主页</a></span><span style="font-size:16px;color: rgb(245, 99, 99);padding-left:20px;">觉得主题不错？支持一下我继续更新吧 -><a href="http://www.kanade.pw" target="_blank">捐赠</a></span>
    </h2>
