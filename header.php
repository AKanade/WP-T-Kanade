...
<body <?php body_class(); ?>>
<header style="" id="header" class="header">
<div class="container-inner">
	<div class="container">
		<div class="navnotice">
		<p><i class="fa fa-volume-up"></i> <?php echo dopt('d_tui'); ?></p>
		</div>
	<div class="login">
		<?php
			if( dopt('d_sign_b') ){ 
	...
	<?php if(is_user_logged_in()){echo '<i class="fa fa-user"></i> <a href="/admin">'.$u_name.'</a> &nbsp; '; echo ' &nbsp; &nbsp; <i class="fa fa-power-off"></i> ';}else{echo '<i class="fa fa-user"></i> ';}; wp_loginout(); ?>
	</div>
	<?php } ?>
	</div>
 <div class="Moe-logo">
                    <a href="/">
                        <h1 class="shake shake-slow">
						                              
                                                        <span style="color: rgb(27, 156, 223);font-family:Microsoft YaHei;font-weight:bold" class="Moe-mono"><?php bloginfo('name'); ?></span>
                                                        <span style="color: rgb(0, 139, 255);font-family:Microsoft JhengHei" class="Moe-bloger"><?php bloginfo('description'); ?></span>
                                                    </h1>
                    </a>
    </div>
</div>
...
<div class="search-expand" style="display: none;"><div class="search-expand-inner"><form method="get" class="searchform themeform" onsubmit="location.href='<?php echo home_url('/search/'); ?>' + encodeURIComponent(this.s.value).replace(/%20/g, '+'); return false;" action="/"><div> <input type="ext" class="search" name="s" onblur="if(this.value=='')this.value='search...';" onfocus="if(this.value=='search...')this.value='';" value=""></div></form></div></div>
</li>
		</ul>
	</div>
