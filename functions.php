...
err('写点中文吧，博主看不懂日本文！You should type some Chinese word!');  
}
return( $comment_data );  
}  
...
function yg_adv_blogroll_register() {
	...
	$name = __('友情链接', 'advanced_blogroll');
